...
faq:
  ...
  - q: Peut-on opérer la cataracte quand on a un kératocône ?
    a: Oui, mais le calcul de l'implant demande des formules spécifiques adaptées aux cornées irrégulières. C'est un sujet que le Dr Moussa a présenté en congrès national d'ophtalmologie.
---
