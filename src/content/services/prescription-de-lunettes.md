...
symptoms:
  ...
  - Images déformées ou dédoublées (astigmatisme)
  - Fatigue visuelle en fin de journée ou sur écran
  - Maux de tête répétés
  - Plissement des yeux pour voir net
whenToConsult:
  - Dès qu'une gêne visuelle apparaît, de loin comme de près
  - Tous les 1 à 2 ans pour vérifier une correction existante
  - Après 40 ans, pour dépister la presbytie
  - Chez l'enfant, dès la maternelle ou en cas de difficulté scolaire
treatments:
  - title: Réfraction automatisée de haute précision
    text: L'auto-réfractomètre NIDEK TONOREF III et le réfracteur RT-6100 permettent une mesure objective puis subjective de votre correction, affinée verre par verre.
...
faq:
  ...
  - q: À quelle fréquence changer de lunettes ?
    a: En moyenne tous les 2 ans chez l'adulte, plus souvent chez l'enfant ou en cas d'évolution rapide de la vue. Un contrôle régulier permet d'ajuster la correction au bon moment.
  - q: La vision sur écran nécessite-t-elle des verres particuliers ?
